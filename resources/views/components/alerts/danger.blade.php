...
class="p-4 mb-4 text-lg text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" role="alert">
