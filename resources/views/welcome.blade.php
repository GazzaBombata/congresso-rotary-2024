...
<x-layout>
  ...
  <main>
  <x-hero 
    mdOnlyPrompt="Visualizza gli eventi" 
    ...
    :mdOnlyCta="['name' => 'Vedi tutti', 'url' => '/events']" 
    :primaryCta="['name' => 'Registrati', 'url' => '/register']" 
    :secondaryCta="['name' => 'Consulta l\'elenco eventi', 'url' => '/events']" 
  />
  </main>
</x-layout>
